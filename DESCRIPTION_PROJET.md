...
- **Paramètres de Simulation Globaux (Modifiables en direct) :**
    - Coût horaire chargé du gérant (€/h) (défaut : 27.30 €/h).
...
- **Calculs et KPIs en temps réel :**
    ...
    - Coût main d'œuvre (Labor Cost) basé sur le temps de production × coût horaire chargé SAS (27.30 €/h).
...
- `CHARGED_HOURLY_RATE = 27.30` : Coût horaire chargé du gérant de SAS (basé sur 15.00 €/h net × 1.82 charges patronales et salariales).
